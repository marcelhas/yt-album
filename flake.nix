  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        mainScript =
          (pkgs.writeScriptBin mainScriptName (builtins.readFile ./yt-album.sh)).overrideAttrs
            (old: {
              buildCommand = ''
                ${old.buildCommand}
                 patchShebangs $out'';
        ...
        testScript =
          (pkgs.writeScriptBin testScriptName (builtins.readFile ./test.sh)).overrideAttrs
            (old: {
              buildCommand = ''
                ${old.buildCommand}
                 patchShebangs $out'';
